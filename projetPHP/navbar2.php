    ...
    <header class="header">
        <nav class="nav container">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    <li>
                        <a href="../src/scroll_animation/index.php" class="nav__link"><i class="bi bi-cart4"></i>
                                    ...
                                    <div class="dropdown__content">
                                        <div class="dropdown__group">
                                            ...
                                            <ul class="dropdown__list">
                                                <li>
                                                    <a href="../src/scroll_animation/allproduit2.php" class="dropdown__link">Afficher tout les produits</a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="dropdown__container">
                                    <div class="dropdown__content">
                                        <div class="dropdown__group">
                                            ...
                                            <ul class="dropdown__list">
                                                <li>
                                                    <a href="#" class="dropdown__link">Play station 5</a>
                                                </li>
                                                <li>
                                                    <a href="#" class="dropdown__link">Play station 4</a>
                                                </li>
                                                <li>
                                                    <a href="#" class="dropdown__link">Play station 3</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="dropdown__group">
                                            ...
                                            <ul class="dropdown__list">
                                                <li>
                                                    <a href="#" class="dropdown__link">Xbox series X</a>
                                                </li>
                                                <li>
                                                    <a href="#" class="dropdown__link">Xbox series S</a>
                                                </li>
                                                <li>
                                                    <a href="#" class="dropdown__link">Xbox One S</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="dropdown__group">
                                            ...
                                            <ul class="dropdown__list">
                                                ...
                                                <li>
                                                    <a href="#" class="dropdown__link">Gaming Pc</a>
                                                </li>
                                            </ul>
                                        </div>
...
//    var_dump($_SESSION['description']); 
        ...
        ?>
            <a href="../src/scroll_animation/PANIER.php" class="btn btn-warning" style="width: auto; height: 40px; "><i class="bi bi-cart4"></i>&nbsp(<?php echo count($_SESSION['Paniers']) - 1; ?>)</i>
            </a>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <?php } else { ?>
            <a href="PANIER.php" class="btn btn-warning" style="width: auto; height: 40px; "><i class="bi bi-cart4"></i><?php echo count($_SESSION['Paniers']) ; ?></i></a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <!--=============== MAIN JS ===============-->
    <script src="../src/scroll_animation/responsive-navigation-bar/assets/js/main.js"></script>
</body>
